 ...
 *
 * THE THREE RUN TIERS (2026-07-15). One model family, three measured profiles:
 *  - normal  (DEFAULT) — UD-IQ2_XXS + MTP, 11.8 GB weights: 88.9% on the certified 117-case
 ...
 *  - pro     — UD-Q3_K_XL + MTP, 17.2 GB weights: ~58 tok/s, the quality-max local profile.
 */
