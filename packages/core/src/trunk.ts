...
export type { SubjectRule, TrunkBlock, TrunkLine, TrunkRow } from './trunk-fold.js';
 ...
 * (`trunk-fold.ts`), so a caller can count it per subject rather than infer it from the bytes.
 */
