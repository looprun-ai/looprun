...
/** Root of the packages tree — every structural lint scans this whole border, so a
 *  retired identifier or a banned import fails the gate in any package. */
export const TREE_ROOT = join(fileURLToPath(import.meta.url), '../../../..');

export interface SourceFile {
  /** Path relative to the packages tree root, posix separators. */
  readonly rel: string;
