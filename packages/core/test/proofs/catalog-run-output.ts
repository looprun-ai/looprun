  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'A new media asset was generated.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'createMedia', args: { prompt: 'a mountain at dawn' } }],
          [{ tool: 'respond', args: { message: 'The media quota is exhausted, so a new asset was not generated right now.', did: [] } }],
        ],
        expect: 'veto',
        tool: 'createMedia',
      },
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'Two items were created — Alpha and Beta.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    ...
    },
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'createItem', args: { title: 'Alpha' } }],
          [{ tool: 'createItem', args: { title: 'Alpha' } }],
          [{ tool: 'respond', args: { message: 'One item named Alpha was created.', did: [] } }],
        ],
        expect: 'veto',
        tool: 'createItem',
      },
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'That deletion still needs your confirmation — are you sure?', did: [] } }],
        ],
        expect: 'veto',
        tool: 'deleteItem',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'Delete item itm-1 — are you sure?', asked: true, did: [] } }],
          [{ tool: 'deleteItem', args: { id: 'itm-1', confirmed: true } }],
          [{ tool: 'respond', args: { message: 'The item was deleted as requested.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    ...
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'purgeAll', args: {} }],
          [{ tool: 'respond', args: { message: 'Purging everything needs your confirmation first — are you sure?', did: [] } }],
        ],
        expect: 'veto',
        tool: 'purgeAll',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'respond', args: { message: 'This will purge every item — are you sure?', asked: true, did: [] } }],
          [{ tool: 'purgeAll', args: {} }],
          [{ tool: 'respond', args: { message: 'Every item is gone now, as you confirmed.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    ...
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'respond', args: { message: 'Delete item itm-1 — are you sure?', asked: true, did: [] } }],
          [{ tool: 'deleteItem', args: { id: 'itm-1' } }],
          [{ tool: 'respond', args: { message: 'The item still requires your confirmation before removal — are you sure?', asked: true, did: [] } }],
        ],
        expect: 'pass',
      },
    },
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'respond', args: { message: 'This will purge every item — are you sure?', asked: true, did: [] } }],
          [{ tool: 'purgeAll', args: {} }],
          [{ tool: 'respond', args: { message: 'Every item is gone now, as agreed.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'deleteItem', args: { id: 'itm-1' } }],
          [{ tool: 'respond', args: { message: 'Delete itm-1 and purge everything — are you sure?', asked: true, did: [] } }],
          [{ tool: 'deleteItem', args: { id: 'itm-1', confirmed: true } }],
          [{ tool: 'purgeAll', args: {} }],
          [{ tool: 'respond', args: { message: 'Item itm-1 was deleted; the purge can run next turn.', did: [] } }],
        ],
        expect: 'veto',
        tool: 'purgeAll',
        turn: 1,
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'There is 1 item, and the status is normal.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'Here are the items on page 2.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          ...
          [{ tool: 'respond', args: { message: 'Only the first three pages are available — try a page within that range.', did: [] } }],
        ],
        expect: 'veto',
        tool: 'listItems',
      },
  ...
  cases: [
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'searchItem', args: { query: 'items' } }],
          [{ tool: 'respond', args: { message: 'What condition is the item in?', asked: true, did: [] } }],
          [{ tool: 'createItem', args: { title: 'Alpha', condition: 'good' } }],
          [{ tool: 'respond', args: { message: 'Item Alpha has been created with the condition you provided.', did: [] } }],
        ],
        expect: 'pass',
      },
    },
    {
      ...
      l3: {
        ...
        script: [
          [{ tool: 'searchItem', args: { query: 'items' } }],
          [{ tool: 'createItem', args: { title: 'Alpha', condition: 'good' } }],
          [{ tool: 'respond', args: { message: 'I need the item’s condition confirmed before I record it — what condition is it in?', did: [] } }],
        ],
        expect: 'veto',
        tool: 'createItem',
      },
