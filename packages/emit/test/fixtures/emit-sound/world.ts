/** The sound fixture's world card: three acts over two record families, and one gate the WORLD
 *  itself enforces — a refund lands only on an invoice that is still open. The gate is what puts
 *  a row in the seam table: a refusal the operator meets as a bare code. */
