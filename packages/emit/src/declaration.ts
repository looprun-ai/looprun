...
const FACTORIES: ReadonlySet<DeclaredGuard['factory']> = new Set(['onlyAfter', 'precondition', 'role', 'valueFromUser', 'argMatchesFormat', 'argForbidden', 'cap', 'checkResult', 'mustAccountFor', 'blockPattern', 'argCondition', 'valueFromUserOrRecord', 'argMatchesRecord', 'onlyAfterWhen', 'prose', 'deny']);
