...
export interface DeclaredGuard {
  ...
  readonly factory: 'needs' | 'precondition' | 'role' | 'valueFromUser'
    ...
    | 'idNamedByUser' | 'argRequired' | 'prose' | 'deny';
...
const FACTORIES: ReadonlySet<DeclaredGuard['factory']> = new Set(['needs', 'precondition', 'role', 'valueFromUser', 'argMatchesFormat', 'argForbidden', 'maxCalls', 'resultSatisfiesCondition', 'mustAccountFor', 'blockPattern', 'argSatisfiesCondition', 'valueFromUserOrRecord', 'argMatchesRecord', 'idNamedByUser', 'argRequired', 'prose', 'deny']);
