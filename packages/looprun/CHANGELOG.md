...
- Updated dependencies
  ...
  - @looprun-ai/models@0.22.2
  - @looprun-ai/server@0.22.2
...
- Updated dependencies [db93b7d]
  ...
  - @looprun-ai/models@0.22.0
  - @looprun-ai/server@0.22.0
...
- Updated dependencies [7a03a19]
  ...
  - @looprun-ai/models@0.21.0
  - @looprun-ai/server@0.21.0

## 0.20.0

### Minor Changes

- d9a4377: A report that hides nothing passes, and the result decides whether a disclosure is printed.

  - `claimIsComplete` spends declarations against acts in either direction: a complete report passes
    in the agent's own order, and the deny for a hidden act names the tool and the word its evidence
    grounds — never a world fact.
  - `disclose.after` is offered on every ok call of the turn, reads included, and the result decides
    whether it prints: a refused call states nothing, and a sentence authored for a read tool lands on
    the turn that read it — the only place the engine can speak when the reply refuses and no act runs.
  - The reads an open consent question owes are forced, never asked for: a `before` slot naming a read
    that never ran triggers one forced single-tool generation before the reply is composed, through the
    same guard hooks as any call. Only a read the acting agent holds is forced, and the pass blocks
    nothing — a read that fails leaves the marker standing.

- Release (minor).

### Patch Changes

- Updated dependencies [d9a4377]
- Updated dependencies
  - @looprun-ai/core@0.20.0
  - @looprun-ai/mastra@0.20.0
  - @looprun-ai/models@0.20.0
  - @looprun-ai/vercel@0.20.0
...
- Updated dependencies [c1df614]
- Updated dependencies
  - @looprun-ai/core@0.19.0
  - @looprun-ai/mastra@0.19.0
  - @looprun-ai/models@0.19.0
  - @looprun-ai/vercel@0.19.0
...
- Updated dependencies [ae59493]
  ...
  - @looprun-ai/mastra@0.17.0
  - @looprun-ai/models@0.17.0
  - @looprun-ai/vercel@0.17.0
...
- Updated dependencies
  ...
  - @looprun-ai/mastra@0.16.0
  - @looprun-ai/models@0.16.0
  - @looprun-ai/vercel@0.16.0
...
- Updated dependencies
  ...
  - @looprun-ai/mastra@0.15.0
  - @looprun-ai/models@0.15.0
  - @looprun-ai/vercel@0.15.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.14.0
  - @looprun-ai/vercel@0.14.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.13.0
  - @looprun-ai/vercel@0.13.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.12.0
  - @looprun-ai/vercel@0.12.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.11.0
  - @looprun-ai/vercel@0.11.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.10.0
  - @looprun-ai/vercel@0.10.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.9.1
  - @looprun-ai/vercel@0.9.1
...
- Updated dependencies [917340f]
  ...
  - @looprun-ai/models@0.9.0
  - @looprun-ai/vercel@0.9.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.8.1
  - @looprun-ai/vercel@0.8.1
...
- Updated dependencies [c55d784]
  ...
  - @looprun-ai/models@0.8.0
  - @looprun-ai/vercel@0.8.0
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.7.2
  - @looprun-ai/vercel@0.7.2
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.7.1
  - @looprun-ai/vercel@0.7.1
...
- Updated dependencies
  ...
  - @looprun-ai/models@0.7.0
  - @looprun-ai/vercel@0.7.0
