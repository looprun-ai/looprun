...
export { boilerplate, capPaths, census, conductComplete, destructiveDisclosed, doubleStated, echoes, floorRedeclared, inertChecks, nameGate, overWide, pairing, pairingTable, profile, promptLines, ruleCopies, purity, seamCovered, surfaceOf, unlicensed } from './lints.js';
