...
/**
 * UNSAT-RISK: a reply requirement no reply can satisfy — guard X REQUIRES a string (the `targets` of
 * claimCoversRubric, each of which must be covered — via `meta.requiredStrings`) that another
