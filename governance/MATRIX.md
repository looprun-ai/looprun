...
| 2026-07-15 | [same-step-terminal-ledger-fix](proofs/2026-07-15-same-step-terminal-ledger-fix.md) | Runtime hardening: terminal calls recorded in the guard hook's synchronous segment (emission order) — closes the same-step ask-then-act concurrency bypass; the previously L1-only deny is L3-proven again | runtime | 166/166 | 48/48 | 27/27 | 46/46 (model micro, advisory) | PASS |
