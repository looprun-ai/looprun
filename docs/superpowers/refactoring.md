...
1. Generate a blueprint with high-level AS-IS diagrams of looprun, organized by the main packages (core, mastra, etc)
   [STATUS: DONE — delivered at docs/superpowers/2026-08-12-blueprint-as-is.md]
...
2.2 CRITICAL:
	...
	- Backward compatibility is not required, but YOU MUST FOLLOW docs/superpowers/requirements.md
...
Task 1 (AS-IS blueprint) is DONE: docs/superpowers/2026-08-12-blueprint-as-is.md
