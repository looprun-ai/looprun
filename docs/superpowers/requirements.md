...
AS-IS capability record (`docs/superpowers/2026-08-12-blueprint-as-is.md`), and the
maintainer's laws.
...
`dubious-status-names` sections; `docs/superpowers/lessons-learned.md`). A name that does not CLEARLY state
