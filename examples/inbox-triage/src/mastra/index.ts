/**
 * src/mastra/index.ts — minimal Mastra registration of the generated LoopRunAgent.
 *
 * The agent = one governed AgentSpec on the deterministic world (fresh world per session).
...
import { SPECS } from '../agents/inbox-triage/index.js';
