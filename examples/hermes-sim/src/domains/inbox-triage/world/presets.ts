...
function mixedEmails(): EmailRec[] {
  return [
    ...
    },
    {
      ...
      snippet: 'Limited stock — ergonomic chairs, standing desks, and monitor variants on sale…',
      body: 'Limited stock: ergonomic chairs 40% off, standing desks and monitor variants also on sale this week.',
      category: 'newsletter',
      urgent: false,
